...
// 1️⃣ Lấy danh sách địa điểm (Mặc định hiển thị trên trang chủ)
...
// 2️⃣ Lấy danh sách phòng thuê (Mặc định hiển thị trên trang chủ)
...
// 3️⃣ API tìm kiếm địa điểm (Gợi ý khi người dùng nhập)
