...
const getHeaders = () => {
    ...
    return {
        Authorization: `Bearer ${token}`, // 🛠 Token của user đăng nhập
        TokenCybersoft: TOKEN_CYBERSOFT, // 🛠 Token của Cybersoft
        "Content-Type": "application/json",
    };
};
...
export const addRoom = async (roomData) => {
    try {
        const headers = getHeaders(); // 🛠 Lấy headers chứa 2 token
