...
const Profile = () => {
    ...
    const fetchUserBookings = async () => {
        try {
            ...
            // Kiểm tra xem có booking nào có `maNguoiDung` khác `userId` không
            data.forEach((booking) => {
                if (booking.maNguoiDung !== parseInt(userId)) {
                    console.warn(
                        `⚠ Lỗi: Booking ${booking.id} có maNguoiDung ${booking.maNguoiDung} KHÔNG trùng với userId ${userId}`
                    );
                }
            });
